...
if ($_POST['btn_submit'] == 'ดำเนินการต่อ') {
    ...
    if ($cpt != $_SESSION['CAPTCHA']) {
        ...
        if ($orders->Save()) {
            ...
            $mail->AddCC('kungking_09042554@hotmail.com', 'beauty-bykk.com'); //สำเนาส่งถึง เมล์เจ้าของร้าน
            $mail->AddReplyTo('kungking_09042554@hotmail.com', 'beauty-bykk.com'); //ตอบกลับถึง เมล์เจ้าของร้าน
